...
**Task:** `S-1.1`. **Status:** draft; independent review pending.

**Source:** [OPS/c01.xhtml](../../../01-source/private/epub/OPS/c01.xhtml#c1_1); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 10 to 19 (end exclusive); printed markers 3–4. These are not Word page numbers.
...
State the research-factory objective and distinguish empirically useful financial ML from elegant but untested theory.

## Cautions to cross-check

Do not turn the author's motivating claims into guarantees of investment performance.
