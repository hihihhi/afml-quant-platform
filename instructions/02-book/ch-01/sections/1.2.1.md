...
**Task:** `S-1.2.1`. **Status:** draft; independent review pending.

**Source:** [OPS/c01.xhtml](../../../01-source/private/epub/OPS/c01.xhtml#c1_2_1); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 23 to 29 (end exclusive); printed markers 4–5. These are not Word page numbers.
...
Identify and prohibit isolated end-to-end strategy discovery without shared specialist evidence and infrastructure.

## Cautions to cross-check

A collection of independent agents does not automatically constitute a collaborative research process.
