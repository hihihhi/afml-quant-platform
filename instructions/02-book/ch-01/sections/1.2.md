...
**Task:** `S-1.2`. **Status:** draft; independent review pending.

**Source:** [OPS/c01.xhtml](../../../01-source/private/epub/OPS/c01.xhtml#c1_2); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 19 to 23 (end exclusive); printed markers 4–4. These are not Word page numbers.
...
Record the organizational failure mode that motivates the rest of the book.

## Cautions to cross-check

Treat this as a research-process requirement, not a trading signal.
...
- [S-1.2.1 — 1.2.1 The Sisyphus Paradigm](1.2.1.md)
- [S-1.2.2 — 1.2.2 The Meta-Strategy Paradigm](1.2.2.md)
