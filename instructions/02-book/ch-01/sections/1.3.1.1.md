...
**Task:** `S-1.3.1.1`. **Status:** draft; independent review pending.

**Source:** [OPS/c01.xhtml](../../../01-source/private/epub/OPS/c01.xhtml#Page_7); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 51 to 57 (end exclusive); printed markers 7–7. These are not Word page numbers.
...
Specify collection, cleaning, indexing, storage, adjustment and delivery responsibilities with asset-specific data context.

## Cautions to cross-check

The book explicitly leaves much specialized data curation outside its scope; do not invent vendor rules and attribute them to it.
