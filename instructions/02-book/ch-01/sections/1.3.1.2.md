...
**Task:** `S-1.3.1.2`. **Status:** draft; independent review pending.

**Source:** [OPS/c01.xhtml](../../../01-source/private/epub/OPS/c01.xhtml#c1_3_1_2); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 57 to 62 (end exclusive); printed markers 7–7. These are not Word page numbers.
...
Define a reusable catalogue of informative features, with labels, weights and evidence of importance.

## Cautions to cross-check

The source distinguishes discovering a feature from developing a strategy.
