...
**Task:** `S-1.3.1.3`. **Status:** draft; independent review pending.

**Source:** [OPS/c01.xhtml](../../../01-source/private/epub/OPS/c01.xhtml#c1_3_1_3); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 62 to 67 (end exclusive); printed markers 7–7. These are not Word page numbers.
...
Require a stated economic mechanism and a testable strategy theory built from informative observations.

## Cautions to cross-check

Combining features or finding a profitable backtest is not itself an explanatory theory.
