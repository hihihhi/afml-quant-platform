...
**Task:** `S-1.3.1.4`. **Status:** draft; independent review pending.

**Source:** [OPS/c01.xhtml](../../../01-source/private/epub/OPS/c01.xhtml#Page_8); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 67 to 73 (end exclusive); printed markers 8–8. These are not Word page numbers.
...
Define independent backtesting responsibilities and verification of the strategist's submitted specification.

## Cautions to cross-check

Keep development choices separate from evaluation evidence; do not let a backtester silently redesign a failed strategy.
