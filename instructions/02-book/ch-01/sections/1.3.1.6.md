...
**Task:** `S-1.3.1.6`. **Status:** draft; independent review pending.

**Source:** [OPS/c01.xhtml](../../../01-source/private/epub/OPS/c01.xhtml#c1_3_1_6); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 78 to 97 (end exclusive); printed markers 8–9. These are not Word page numbers.
...
Capture portfolio-level oversight, allocation and monitoring responsibilities.

## Cautions to cross-check

Strategy-level success does not establish portfolio-level diversification or acceptable combined risk.
