...
**Task:** `S-1.3.2.1`. **Status:** draft; independent review pending.

**Source:** [OPS/c01.xhtml](../../../01-source/private/epub/OPS/c01.xhtml#c1_3_2_1); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 488 to 501 (end exclusive); printed markers 9–9. These are not Word page numbers.
...
Record the data component's problems, remedies and referenced chapters.

## Cautions to cross-check

Retain the source's distinctions between raw information and ready-made processed datasets.
