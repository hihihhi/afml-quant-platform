...
**Task:** `S-1.3.2.2`. **Status:** draft; independent review pending.

**Source:** [OPS/c01.xhtml](../../../01-source/private/epub/OPS/c01.xhtml#c1_3_2_2); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 501 to 512 (end exclusive); printed markers 9–10. These are not Word page numbers.
...
Record the software component's reproducibility and implementation implications.

## Cautions to cross-check

Do not mistake an illustrative Python snippet for a complete production service.
