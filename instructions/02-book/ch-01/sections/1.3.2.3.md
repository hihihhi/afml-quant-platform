...
**Task:** `S-1.3.2.3`. **Status:** draft; independent review pending.

**Source:** [OPS/c01.xhtml](../../../01-source/private/epub/OPS/c01.xhtml#c1_3_2_3); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 512 to 523 (end exclusive); printed markers 10–10. These are not Word page numbers.
...
Record the hardware component's computational requirements and later HPC references.

## Cautions to cross-check

A hardware shopping list or latency promise is not supplied by the chapter.
