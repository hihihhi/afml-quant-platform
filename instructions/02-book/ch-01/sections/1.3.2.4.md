...
**Task:** `S-1.3.2.4`. **Status:** draft; independent review pending.

**Source:** [OPS/c01.xhtml](../../../01-source/private/epub/OPS/c01.xhtml#c1_3_2_4); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 523 to 540 (end exclusive); printed markers 10–11. These are not Word page numbers.
...
Record the mathematical toolchain and links to relevant derivations and computational methods.

## Cautions to cross-check

Every mathematical dependency needs a reviewed definition, not a name-only placeholder.
