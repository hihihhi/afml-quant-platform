...
**Task:** `S-1.3.2.5`. **Status:** draft; independent review pending.

**Source:** [OPS/c01.xhtml](../../../01-source/private/epub/OPS/c01.xhtml#c1_3_2_5); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 540 to 552 (end exclusive); printed markers 11–11. These are not Word page numbers.
...
Require reusable methods for producing and evaluating strategies rather than searching for one magical formula.

## Cautions to cross-check

Feature combinations and repeated trials must remain visible in the research history.
