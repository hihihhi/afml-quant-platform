...
**Task:** `S-1.4`. **Status:** draft; independent review pending.

**Source:** [OPS/c01.xhtml](../../../01-source/private/epub/OPS/c01.xhtml#c1_4); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 705 to 712 (end exclusive); printed markers 12–13. These are not Word page numbers.
...
Record the expected audience and distinguish prerequisite teaching from book-derived implementation requirements.

## Cautions to cross-check

Do not assume the source teaches every prerequisite or replace missing background with unlabeled additions.
