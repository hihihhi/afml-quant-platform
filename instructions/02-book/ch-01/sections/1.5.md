...
**Task:** `S-1.5`. **Status:** draft; independent review pending.

**Source:** [OPS/c01.xhtml](../../../01-source/private/epub/OPS/c01.xhtml#c1_5); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 712 to 719 (end exclusive); printed markers 13–14. These are not Word page numbers.
...
Catalogue required mathematics and Python-library behavior that a native port must reproduce or explicitly revise.

## Cautions to cross-check

Historical library conventions and bugs must be version-qualified before execution.
