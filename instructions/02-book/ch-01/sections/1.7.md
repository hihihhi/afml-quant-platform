...
**Task:** `S-1.7`. **Status:** draft; independent review pending.

**Source:** [OPS/c01.xhtml](../../../01-source/private/epub/OPS/c01.xhtml#c1_7); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 782 to 792 (end exclusive); printed markers 18–18. These are not Word page numbers.
...
Preserve acknowledgments and attribution as source apparatus.

## Cautions to cross-check

No implementation task or external contact action should be inferred from acknowledgments.
