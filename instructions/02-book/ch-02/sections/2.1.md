...
**Task:** `S-2.1`. **Status:** draft; independent review pending.

**Source:** [OPS/c02.xhtml](../../../01-source/private/epub/OPS/c02.xhtml#c2_1); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 12 to 16 (end exclusive); printed markers 23–23. These are not Word page numbers.
...
Define the transition from unstructured raw financial observations to a structured ML dataset.

## Cautions to cross-check

Do not discard the raw source or treat a vendor's processed dataset as information-neutral.
