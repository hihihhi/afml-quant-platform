...
**Task:** `S-2.2.2`. **Status:** draft; independent review pending.

**Source:** [OPS/c02.xhtml](../../../01-source/private/epub/OPS/c02.xhtml#c2_2_2); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 80 to 86 (end exclusive); printed markers 24–25. These are not Word page numbers.
...
Preserve market event context and the distinctions among trades, quotes, cancellations and related observations.

## Cautions to cross-check

Volume, price and timestamps alone may not identify the event that actually occurred.
