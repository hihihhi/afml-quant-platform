...
**Task:** `S-2.2.3`. **Status:** draft; independent review pending.

**Source:** [OPS/c02.xhtml](../../../01-source/private/epub/OPS/c02.xhtml#c2_2_3); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 86 to 91 (end exclusive); printed markers 25–25. These are not Word page numbers.
...
Record analytics as derived information with its producing method and time of availability.

## Cautions to cross-check

A vendor's analytics can embed its own assumptions and processing history.
