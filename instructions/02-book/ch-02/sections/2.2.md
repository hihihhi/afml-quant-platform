...
**Task:** `S-2.2`. **Status:** draft; independent review pending.

**Source:** [OPS/c02.xhtml](../../../01-source/private/epub/OPS/c02.xhtml#c2_2); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 16 to 72 (end exclusive); printed markers 23–23. These are not Word page numbers.
...
Catalogue the four essential financial-data categories and their distinct availability semantics.

## Cautions to cross-check

A shared schema must not erase category-specific meaning.
...
- [S-2.2.1 — 2.2.1 Fundamental Data](2.2.1.md)
- [S-2.2.2 — 2.2.2 Market Data](2.2.2.md)
- [S-2.2.3 — 2.2.3 Analytics](2.2.3.md)
- [S-2.2.4 — 2.2.4 Alternative Data](2.2.4.md)
