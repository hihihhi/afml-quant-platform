...
**Task:** `S-2.3.1.2`. **Status:** draft; independent review pending.

**Source:** [OPS/c02.xhtml](../../../01-source/private/epub/OPS/c02.xhtml#c2_3_1_2); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 121 to 130 (end exclusive); printed markers 26–27. These are not Word page numbers.
...
Specify tick-count accumulation, bar closure and resulting fields.

## Cautions to cross-check

A tick's definition and exchange or vendor aggregation can change the effective sampling unit.
