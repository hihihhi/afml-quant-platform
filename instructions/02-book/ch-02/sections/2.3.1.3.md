...
**Task:** `S-2.3.1.3`. **Status:** draft; independent review pending.

**Source:** [OPS/c02.xhtml](../../../01-source/private/epub/OPS/c02.xhtml#c2_3_1_3); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 130 to 137 (end exclusive); printed markers 27–27. These are not Word page numbers.
...
Specify cumulative-volume thresholds and bar construction.

## Cautions to cross-check

Keep the volume unit explicit and preserve the original event sequence at threshold crossings.
