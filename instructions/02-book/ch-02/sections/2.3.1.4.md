...
**Task:** `S-2.3.1.4`. **Status:** draft; independent review pending.

**Source:** [OPS/c02.xhtml](../../../01-source/private/epub/OPS/c02.xhtml#c2_3_1_4); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 137 to 153 (end exclusive); printed markers 27–28. These are not Word page numbers.
...
Specify cumulative traded-dollar-value thresholds and their motivation.

## Cautions to cross-check

Price scale, currency and corporate actions affect comparability; do not silently substitute share volume.
