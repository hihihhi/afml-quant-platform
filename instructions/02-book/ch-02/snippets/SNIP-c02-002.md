...
**Task:** `SNIP-c02-002`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 726 to 727 (end exclusive); printed markers 37–37. These are not Word page numbers.
...
Original asset: [OPS/images/s02-02.jpg](../../../01-source/private/epub/OPS/images/s02-02.jpg).
