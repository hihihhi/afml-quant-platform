...
**Task:** `SNIP-c02-003`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 734 to 735 (end exclusive); printed markers 37–37. These are not Word page numbers.
...
Original asset: [OPS/images/s02-03.jpg](../../../01-source/private/epub/OPS/images/s02-03.jpg).
