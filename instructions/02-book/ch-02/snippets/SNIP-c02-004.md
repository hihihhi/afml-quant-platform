...
**Task:** `SNIP-c02-004`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 822 to 823 (end exclusive); printed markers 39–39. These are not Word page numbers.
...
Original asset: [OPS/images/s02-04.jpg](../../../01-source/private/epub/OPS/images/s02-04.jpg).
