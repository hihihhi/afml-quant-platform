...
**Task:** `CH-03-bibliography`. **Status:** draft; independent review pending.

**Source:** [OPS/c03.xhtml](../../../01-source/private/epub/OPS/c03.xhtml#bib); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 376 to 461 (end exclusive); printed markers 55–57. These are not Word page numbers.
...
Preserve the bibliography as prerequisite/further-reading source apparatus.

## Cautions to cross-check

Bibliographic inclusion is not an implementation requirement or proof of current validity.
...
- [IMG-c03-00452 — IMG-c03-00452 — c03_ILM0009.gif](../equations/IMG-c03-00452.md)
