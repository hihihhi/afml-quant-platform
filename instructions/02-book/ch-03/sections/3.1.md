...
**Task:** `S-3.1`. **Status:** draft; independent review pending.

**Source:** [OPS/c03.xhtml](../../../01-source/private/epub/OPS/c03.xhtml#c3_1); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 12 to 20 (end exclusive); printed markers 43–43. These are not Word page numbers.
...
Define labeling as an explicit transformation of future outcomes attached to feature observations.

## Cautions to cross-check

Labels may use a future outcome window, but features and fitting inputs must not inherit that future information.
