...
**Task:** `S-3.6`. **Status:** draft; independent review pending.

**Source:** [OPS/c03.xhtml](../../../01-source/private/epub/OPS/c03.xhtml#c3_6); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 250 to 279 (end exclusive); printed markers 49–49. These are not Word page numbers.
...
Specify meta-labels conditional on a primary model's supplied side.

## Cautions to cross-check

The secondary model is not being asked to rediscover buy versus sell; preserve its target semantics.
...
- [SNIP-c03-006 — Snippet 3.6 Expanding getEvents to incorporate meta-labeling](../snippets/SNIP-c03-006.md)
- [SNIP-c03-007 — Snippet 3.7 Expanding getBins to incorporate meta-labeling](../snippets/SNIP-c03-007.md)
