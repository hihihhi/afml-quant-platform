...
**Task:** `S-3.8`. **Status:** draft; independent review pending.

**Source:** [OPS/c03.xhtml](../../../01-source/private/epub/OPS/c03.xhtml#c3_8); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 298 to 311 (end exclusive); printed markers 53–54. These are not Word page numbers.
...
Capture the quantamental workflow combining a discretionary or external primary decision with systematic meta-labeling.

## Cautions to cross-check

The provenance and timestamp of the primary decision remain part of the experiment.
