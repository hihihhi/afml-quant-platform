...
**Task:** `SNIP-c03-001`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 98 to 99 (end exclusive); printed markers 44–44. These are not Word page numbers.
...
Original asset: [OPS/images/s03-01.jpg](../../../01-source/private/epub/OPS/images/s03-01.jpg).
