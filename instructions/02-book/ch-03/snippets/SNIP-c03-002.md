...
**Task:** `SNIP-c03-002`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 152 to 153 (end exclusive); printed markers 45–45. These are not Word page numbers.
...
Original asset: [OPS/images/s03-02.jpg](../../../01-source/private/epub/OPS/images/s03-02.jpg).
