...
**Task:** `SNIP-c03-003`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 207 to 208 (end exclusive); printed markers 48–48. These are not Word page numbers.
...
Original asset: [OPS/images/s03-03.jpg](../../../01-source/private/epub/OPS/images/s03-03.jpg).
