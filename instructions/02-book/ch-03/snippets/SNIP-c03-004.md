...
**Task:** `SNIP-c03-004`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 233 to 234 (end exclusive); printed markers 49–49. These are not Word page numbers.
...
Original asset: [OPS/images/s03-04.jpg](../../../01-source/private/epub/OPS/images/s03-04.jpg).
