...
**Task:** `SNIP-c03-005`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 246 to 247 (end exclusive); printed markers 49–49. These are not Word page numbers.
...
Original asset: [OPS/images/s03-05.jpg](../../../01-source/private/epub/OPS/images/s03-05.jpg).
