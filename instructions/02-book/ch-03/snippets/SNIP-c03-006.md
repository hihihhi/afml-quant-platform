...
**Task:** `SNIP-c03-006`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 265 to 266 (end exclusive); printed markers 49–49. These are not Word page numbers.
...
Original asset: [OPS/images/s03-06.jpg](../../../01-source/private/epub/OPS/images/s03-06.jpg).
