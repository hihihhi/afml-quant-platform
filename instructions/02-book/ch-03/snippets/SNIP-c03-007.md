...
**Task:** `SNIP-c03-007`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 272 to 273 (end exclusive); printed markers 49–49. These are not Word page numbers.
...
Original asset: [OPS/images/s03-07.jpg](../../../01-source/private/epub/OPS/images/s03-07.jpg).
