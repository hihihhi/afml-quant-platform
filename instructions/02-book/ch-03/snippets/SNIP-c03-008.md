...
**Task:** `SNIP-c03-008`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 317 to 318 (end exclusive); printed markers 54–54. These are not Word page numbers.
...
Original asset: [OPS/images/s03-08.jpg](../../../01-source/private/epub/OPS/images/s03-08.jpg).
