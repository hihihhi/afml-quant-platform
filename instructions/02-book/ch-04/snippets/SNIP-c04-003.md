...
**Task:** `SNIP-c04-003`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 319 to 320 (end exclusive); printed markers 64–64. These are not Word page numbers.
...
Original asset: [OPS/images/s04-03.jpg](../../../01-source/private/epub/OPS/images/s04-03.jpg).
