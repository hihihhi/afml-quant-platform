...
**Task:** `SNIP-c04-004`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 325 to 326 (end exclusive); printed markers 64–64. These are not Word page numbers.
...
Original asset: [OPS/images/s04-04.jpg](../../../01-source/private/epub/OPS/images/s04-04.jpg).
