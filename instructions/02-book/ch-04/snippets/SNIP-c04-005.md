...
**Task:** `SNIP-c04-005`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 334 to 335 (end exclusive); printed markers 65–65. These are not Word page numbers.
...
Original asset: [OPS/images/s04-05.jpg](../../../01-source/private/epub/OPS/images/s04-05.jpg).
