...
**Task:** `SNIP-c04-007`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 409 to 410 (end exclusive); printed markers 66–66. These are not Word page numbers.
...
Original asset: [OPS/images/s04-07.jpg](../../../01-source/private/epub/OPS/images/s04-07.jpg).
