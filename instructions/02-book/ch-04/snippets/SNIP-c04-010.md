...
**Task:** `SNIP-c04-010`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 461 to 462 (end exclusive); printed markers 69–69. These are not Word page numbers.
...
Original asset: [OPS/images/s04-10.jpg](../../../01-source/private/epub/OPS/images/s04-10.jpg).
