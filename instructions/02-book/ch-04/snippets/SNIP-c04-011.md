...
**Task:** `SNIP-c04-011`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 507 to 508 (end exclusive); printed markers 70–70. These are not Word page numbers.
...
Original asset: [OPS/images/s04-11.jpg](../../../01-source/private/epub/OPS/images/s04-11.jpg).
