...
**Task:** `S-5.1`. **Status:** draft; independent review pending.

**Source:** [OPS/c05.xhtml](../../../01-source/private/epub/OPS/c05.xhtml#c5_1); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 10 to 14 (end exclusive); printed markers 75–75. These are not Word page numbers.
...
State the objective of making features stationary without unnecessarily discarding memory.

## Cautions to cross-check

Stationarity and predictive usefulness are separate empirical questions.
