...
**Task:** `S-5.3`. **Status:** draft; independent review pending.

**Source:** [OPS/c05.xhtml](../../../01-source/private/epub/OPS/c05.xhtml#c5_3); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 22 to 30 (end exclusive); printed markers 76–77. These are not Word page numbers.
...
Preserve the fractional-differentiation literature framing and references.

## Cautions to cross-check

Claims about the state of the literature are historical source statements, not automatically current facts.
