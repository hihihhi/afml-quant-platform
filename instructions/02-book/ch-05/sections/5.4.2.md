...
**Task:** `S-5.4.2`. **Status:** draft; independent review pending.

**Source:** [OPS/c05.xhtml](../../../01-source/private/epub/OPS/c05.xhtml#c5_4_2); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 110 to 180 (end exclusive); printed markers 78–79. These are not Word page numbers.
...
Reproduce the recursive weight-generation formula and the plotted parameter cases.

## Cautions to cross-check

Check base weight, recursion index and signs against both the equation and the snippet.
...
- [IMG-c05-00119 — IMG-c05-00119 — c05_M0005.gif](../equations/IMG-c05-00119.md)
- [SNIP-c05-001 — Snippet 5.1 Weighting function](../snippets/SNIP-c05-001.md)
