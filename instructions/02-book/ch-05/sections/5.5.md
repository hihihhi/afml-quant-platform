...
**Task:** `S-5.5`. **Status:** draft; independent review pending.

**Source:** [OPS/c05.xhtml](../../../01-source/private/epub/OPS/c05.xhtml#c5_5); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 221 to 225 (end exclusive); printed markers 80–80. These are not Word page numbers.
...
Specify expanding-window and fixed-width implementations as distinct methods.

## Cautions to cross-check

Do not silently switch truncation rules while keeping the same feature identifier.
...
- [S-5.5.1 — 5.5.1 Expanding Window](5.5.1.md)
- [S-5.5.2 — 5.5.2 Fixed-Width Window Fracdiff](5.5.2.md)
