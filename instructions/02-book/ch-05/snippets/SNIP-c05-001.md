...
**Task:** `SNIP-c05-001`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 175 to 176 (end exclusive); printed markers 78–78. These are not Word page numbers.
...
Original asset: [OPS/images/s05-01.jpg](../../../01-source/private/epub/OPS/images/s05-01.jpg).
