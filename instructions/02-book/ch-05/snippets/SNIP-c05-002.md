...
**Task:** `SNIP-c05-002`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 310 to 311 (end exclusive); printed markers 82–82. These are not Word page numbers.
...
Original asset: [OPS/images/s05-02.jpg](../../../01-source/private/epub/OPS/images/s05-02.jpg).
