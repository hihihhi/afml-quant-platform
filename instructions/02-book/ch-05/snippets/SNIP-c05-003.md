...
**Task:** `SNIP-c05-003`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 355 to 356 (end exclusive); printed markers 83–83. These are not Word page numbers.
