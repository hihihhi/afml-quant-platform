...
**Task:** `SNIP-c05-004`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 407 to 408 (end exclusive); printed markers 85–85. These are not Word page numbers.
...
Original asset: [OPS/images/s05-04.jpg](../../../01-source/private/epub/OPS/images/s05-04.jpg).
