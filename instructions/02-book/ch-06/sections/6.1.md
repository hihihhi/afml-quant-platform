...
**Task:** `S-6.1`. **Status:** draft; independent review pending.

**Source:** [OPS/c06.xhtml](../../../01-source/private/epub/OPS/c06.xhtml#c6_1); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 10 to 16 (end exclusive); printed markers 93–93. These are not Word page numbers.
...
Specify the ensemble-method objective in the financial-data setting.

## Cautions to cross-check

Ensembling does not automatically cure bad labels, leakage or false discovery.
