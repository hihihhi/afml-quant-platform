...
**Task:** `S-6.5`. **Status:** draft; independent review pending.

**Source:** [OPS/c06.xhtml](../../../01-source/private/epub/OPS/c06.xhtml#c6_5); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 271 to 287 (end exclusive); printed markers 99–100. These are not Word page numbers.
...
Reproduce the boosting sequence and reweighting of observations after each learner.

## Cautions to cross-check

Noisy financial observations can receive increasing weight; parameter and learner details matter.
