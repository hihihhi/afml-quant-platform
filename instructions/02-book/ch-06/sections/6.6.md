...
**Task:** `S-6.6`. **Status:** draft; independent review pending.

**Source:** [OPS/c06.xhtml](../../../01-source/private/epub/OPS/c06.xhtml#c6_6); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 287 to 300 (end exclusive); printed markers 100–101. These are not Word page numbers.
...
Compare the source's bagging-versus-boosting arguments in the financial context.

## Cautions to cross-check

The preference is contextual, not a theorem that one method wins on every dataset.
