...
**Task:** `SNIP-c06-002`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 265 to 266 (end exclusive); printed markers 99–99. These are not Word page numbers.
...
Original asset: [OPS/images/s06-02.jpg](../../../01-source/private/epub/OPS/images/s06-02.jpg).
