...
**Task:** `S-7.1`. **Status:** draft; independent review pending.

**Source:** [OPS/c07.xhtml](../../../01-source/private/epub/OPS/c07.xhtml#c7_1); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 10 to 14 (end exclusive); printed markers 103–103. These are not Word page numbers.
...
Define generalization-error estimation and why financial CV needs special treatment.

## Cautions to cross-check

CV can participate in overfitting rather than detecting it when its assumptions or use are wrong.
