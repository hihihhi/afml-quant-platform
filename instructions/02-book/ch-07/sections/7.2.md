...
**Task:** `S-7.2`. **Status:** draft; independent review pending.

**Source:** [OPS/c07.xhtml](../../../01-source/private/epub/OPS/c07.xhtml#c7_2); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 14 to 46 (end exclusive); printed markers 103–104. These are not Word page numbers.
...
Reproduce the training/testing separation and k-fold evaluation objective.

## Cautions to cross-check

An evaluation on training data is not evidence of generalization; preserve the distinction between development CV and backtesting.
