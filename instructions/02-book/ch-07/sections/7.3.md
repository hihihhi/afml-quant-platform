...
**Task:** `S-7.3`. **Status:** draft; independent review pending.

**Source:** [OPS/c07.xhtml](../../../01-source/private/epub/OPS/c07.xhtml#c7_3); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 46 to 144 (end exclusive); printed markers 104–105. These are not Word page numbers.
...
Catalogue the non-IID leakage mechanism and repeated-test selection problem separately.

## Cautions to cross-check

Purging overlap is not, by itself, a solution to unlimited researcher trials.
