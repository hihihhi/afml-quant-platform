...
**Task:** `S-7.4.1`. **Status:** draft; independent review pending.

**Source:** [OPS/c07.xhtml](../../../01-source/private/epub/OPS/c07.xhtml#c7_4_1); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 148 to 265 (end exclusive); printed markers 105–107. These are not Word page numbers.
...
Reproduce removal of training events whose label intervals overlap the test information interval.

## Cautions to cross-check

Test all overlap configurations and boundary equality; checking only event start times is insufficient.
...
- [IMG-c07-00197 — IMG-c07-00197 — c07_ILM0001.gif](../equations/IMG-c07-00197.md)
- [SNIP-c07-001 — Snippet 7.1 Purging observation in the training set](../snippets/SNIP-c07-001.md)
