...
**Task:** `S-7.4.2`. **Status:** draft; independent review pending.

**Source:** [OPS/c07.xhtml](../../../01-source/private/epub/OPS/c07.xhtml#c7_4_2); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 265 to 336 (end exclusive); printed markers 107–108. These are not Word page numbers.
...
Reproduce the embargo interval after a test block.

## Cautions to cross-check

Embargo complements purging and must not be confused with deleting a fixed number of arbitrary rows.
...
- [SNIP-c07-002 — Snippet 7.2 Embargo on training observations](../snippets/SNIP-c07-002.md)
