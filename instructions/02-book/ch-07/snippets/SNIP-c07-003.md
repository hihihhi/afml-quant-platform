...
**Task:** `SNIP-c07-003`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 342 to 343 (end exclusive); printed markers 109–109. These are not Word page numbers.
...
Original asset: [OPS/images/s07-03.jpg](../../../01-source/private/epub/OPS/images/s07-03.jpg).
