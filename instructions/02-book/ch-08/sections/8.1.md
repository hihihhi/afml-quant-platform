...
**Task:** `S-8.1`. **Status:** draft; independent review pending.

**Source:** [OPS/c08.xhtml](../../../01-source/private/epub/OPS/c08.xhtml#c8_1); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 10 to 14 (end exclusive); printed markers 113–113. These are not Word page numbers.
...
Define feature-importance analysis as a central research artifact.

## Cautions to cross-check

A feature ranking is not an investment strategy or an independent backtest.
