...
**Task:** `S-8.4`. **Status:** draft; independent review pending.

**Source:** [OPS/c08.xhtml](../../../01-source/private/epub/OPS/c08.xhtml#c8_4); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 78 to 82 (end exclusive); printed markers 115–115. These are not Word page numbers.
...
Specify the methods intended to avoid substitution effects.

## Cautions to cross-check

Avoid interpreting a different importance estimand as numerically interchangeable with MDI or MDA.
...
- [S-8.4.1 — 8.4.1 Single Feature Importance](8.4.1.md)
- [S-8.4.2 — 8.4.2 Orthogonal Features](8.4.2.md)
