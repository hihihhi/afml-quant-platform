...
**Task:** `SNIP-c08-001`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 26 to 27 (end exclusive); printed markers 114–114. These are not Word page numbers.
