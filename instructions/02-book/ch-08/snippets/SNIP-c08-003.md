...
**Task:** `SNIP-c08-003`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 74 to 75 (end exclusive); printed markers 115–115. These are not Word page numbers.
...
Original asset: [OPS/images/s08-03.jpg](../../../01-source/private/epub/OPS/images/s08-03.jpg).
