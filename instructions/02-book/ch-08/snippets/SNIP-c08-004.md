...
**Task:** `SNIP-c08-004`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 94 to 95 (end exclusive); printed markers 118–118. These are not Word page numbers.
...
Original asset: [OPS/images/s08-04.jpg](../../../01-source/private/epub/OPS/images/s08-04.jpg).
