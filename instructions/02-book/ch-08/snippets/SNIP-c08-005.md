...
**Task:** `SNIP-c08-005`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 173 to 174 (end exclusive); printed markers 119–119. These are not Word page numbers.
...
Original asset: [OPS/images/s08-05.jpg](../../../01-source/private/epub/OPS/images/s08-05.jpg).
