...
**Task:** `SNIP-c08-006`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 194 to 195 (end exclusive); printed markers 120–120. These are not Word page numbers.
...
Original asset: [OPS/images/s08-06.jpg](../../../01-source/private/epub/OPS/images/s08-06.jpg).
