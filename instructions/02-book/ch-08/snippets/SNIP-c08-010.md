...
**Task:** `SNIP-c08-010`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 271 to 272 (end exclusive); printed markers 123–123. These are not Word page numbers.
...
Original asset: [OPS/images/s08-10.jpg](../../../01-source/private/epub/OPS/images/s08-10.jpg).
