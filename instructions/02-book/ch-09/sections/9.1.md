...
**Task:** `S-9.1`. **Status:** draft; independent review pending.

**Source:** [OPS/c09.xhtml](../../../01-source/private/epub/OPS/c09.xhtml#c9_1); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 10 to 14 (end exclusive); printed markers 129–129. These are not Word page numbers.
...
Define hyper-parameter selection as an explicitly validated research operation.

## Cautions to cross-check

Searching more settings increases selection opportunities even when each individual fit is correct.
