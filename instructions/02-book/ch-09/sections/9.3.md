...
**Task:** `S-9.3`. **Status:** draft; independent review pending.

**Source:** [OPS/c09.xhtml](../../../01-source/private/epub/OPS/c09.xhtml#c9_3); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 58 to 68 (end exclusive); printed markers 131–131. These are not Word page numbers.
...
Reproduce randomized search over declared parameter distributions.

## Cautions to cross-check

A randomized search distribution is part of the experiment, not an implementation detail.
...
- [S-9.3.1 — 9.3.1 Log-Uniform Distribution](9.3.1.md)
- [SNIP-c09-003 — Snippet 9.3 Randomized search with purged k-fold CV](../snippets/SNIP-c09-003.md)
