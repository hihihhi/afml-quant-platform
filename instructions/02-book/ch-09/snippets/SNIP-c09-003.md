...
**Task:** `SNIP-c09-003`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 64 to 65 (end exclusive); printed markers 131–131. These are not Word page numbers.
...
Original asset: [OPS/images/s09-03.jpg](../../../01-source/private/epub/OPS/images/s09-03.jpg).
