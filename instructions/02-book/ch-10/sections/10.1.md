...
**Task:** `S-10.1`. **Status:** draft; independent review pending.

**Source:** [OPS/c10.xhtml](../../../01-source/private/epub/OPS/c10.xhtml#c10_1); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 10 to 14 (end exclusive); printed markers 141–141. These are not Word page numbers.
...
Define bet sizing as a separate stage from forecasting the trade's side.

## Cautions to cross-check

High predictive confidence does not eliminate exposure, overlap or liquidity constraints.
