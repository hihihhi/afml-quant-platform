...
**Task:** `SNIP-c10-001`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 163 to 164 (end exclusive); printed markers 143–143. These are not Word page numbers.
...
Original asset: [OPS/images/s10-01.jpg](../../../01-source/private/epub/OPS/images/s10-01.jpg).
