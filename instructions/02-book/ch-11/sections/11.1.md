...
**Task:** `S-11.1`. **Status:** draft; independent review pending.

**Source:** [OPS/c11.xhtml](../../../01-source/private/epub/OPS/c11.xhtml#c11_1); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 10 to 16 (end exclusive); printed markers 151–151. These are not Word page numbers.
...
State why backtest interpretation requires a dedicated skepticism and selection-bias protocol.

## Cautions to cross-check

A mechanically correct simulator cannot certify a genuine discovery.
