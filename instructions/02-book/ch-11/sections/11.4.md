...
**Task:** `S-11.4`. **Status:** draft; independent review pending.

**Source:** [OPS/c11.xhtml](../../../01-source/private/epub/OPS/c11.xhtml#c11_4); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 46 to 54 (end exclusive); printed markers 153–153. These are not Word page numbers.
...
Separate hypothesis development from final backtest evaluation.

## Cautions to cross-check

Do not improve a strategy by repeatedly adapting it to the same supposedly out-of-sample backtest.
