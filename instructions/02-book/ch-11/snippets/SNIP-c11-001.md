...
**Task:** `SNIP-c11-001`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 71 to 72 (end exclusive); printed markers 154–154. These are not Word page numbers.
