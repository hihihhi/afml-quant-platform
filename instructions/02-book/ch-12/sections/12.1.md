...
**Task:** `S-12.1`. **Status:** draft; independent review pending.

**Source:** [OPS/c12.xhtml](../../../01-source/private/epub/OPS/c12.xhtml#c12_1); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 10 to 15 (end exclusive); printed markers 161–161. These are not Word page numbers.
...
Define evaluation across alternative paths and distinguish historical from nonhistorical scenarios.

## Cautions to cross-check

Backtesting through CV is not identical to an executable historical track record.
