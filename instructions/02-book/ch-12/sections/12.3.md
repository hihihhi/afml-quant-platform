...
**Task:** `S-12.3`. **Status:** draft; independent review pending.

**Source:** [OPS/c12.xhtml](../../../01-source/private/epub/OPS/c12.xhtml#c12_3); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 40 to 62 (end exclusive); printed markers 162–163. These are not Word page numbers.
...
Reproduce CV-based backtesting and its stated advantages and limitations.

## Cautions to cross-check

Training may occur after a held-out period; do not label the resulting path historically achievable.
