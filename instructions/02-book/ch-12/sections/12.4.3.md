...
**Task:** `S-12.4.3`. **Status:** draft; independent review pending.

**Source:** [OPS/c12.xhtml](../../../01-source/private/epub/OPS/c12.xhtml#c12_4_3); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 229 to 268 (end exclusive); printed markers 165–166. These are not Word page numbers.
...
Reproduce the small combinatorial examples and their path assignments.

## Cautions to cross-check

A correct number of combinations does not prove the path-construction algorithm is correct.
...
- [IMG-c12-00250 — IMG-c12-00250 — c12_ILM0007.gif](../equations/IMG-c12-00250.md)
