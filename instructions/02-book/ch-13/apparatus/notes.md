...
**Task:** `CH-13-notes`. **Status:** draft; independent review pending.

**Source:** [OPS/c13.xhtml](../../../01-source/private/epub/OPS/c13.xhtml#notesSet); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 1083 to 1096 (end exclusive); printed markers 193–193. These are not Word page numbers.
...
Review every note, preserve its anchor and link it to the relevant parent claim.

## Cautions to cross-check

A qualification in a note can materially change the interpretation of a formula or procedure.
