...
**Task:** `S-13.1`. **Status:** draft; independent review pending.

**Source:** [OPS/c13.xhtml](../../../01-source/private/epub/OPS/c13.xhtml#c13_1); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 10 to 16 (end exclusive); printed markers 169–169. These are not Word page numbers.
...
Define synthetic-data backtesting as a separate paradigm from historical simulation.

## Cautions to cross-check

Synthetic validation inherits assumptions of the chosen data-generating process.
