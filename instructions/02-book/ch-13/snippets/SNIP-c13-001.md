...
**Task:** `SNIP-c13-001`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 364 to 365 (end exclusive); printed markers 174–174. These are not Word page numbers.
...
Original asset: [OPS/images/s13-01.jpg](../../../01-source/private/epub/OPS/images/s13-01.jpg).
