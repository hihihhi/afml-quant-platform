...
**Task:** `SNIP-c13-002`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 384 to 385 (end exclusive); printed markers 175–175. These are not Word page numbers.
...
Original asset: [OPS/images/s13-02.jpg](../../../01-source/private/epub/OPS/images/s13-02.jpg).
