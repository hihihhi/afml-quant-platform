# IMG-c14-00440 — c14_ILM0021.gif

**Task:** `IMG-c14-00440`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 440 to 441 (end exclusive); printed markers 204–204. These are not Word page numbers.
