...
**Task:** `S-14.1`. **Status:** draft; independent review pending.

**Source:** [OPS/c14.xhtml](../../../01-source/private/epub/OPS/c14.xhtml#c14_1); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 10 to 16 (end exclusive); printed markers 195–195. These are not Word page numbers.
...
Specify the families of statistics needed to interpret a backtest beyond total return.

## Cautions to cross-check

No single summary metric is a complete strategy evaluation.
