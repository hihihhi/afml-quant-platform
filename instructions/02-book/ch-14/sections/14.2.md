...
**Task:** `S-14.2`. **Status:** draft; independent review pending.

**Source:** [OPS/c14.xhtml](../../../01-source/private/epub/OPS/c14.xhtml#c14_2); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 16 to 20 (end exclusive); printed markers 195–195. These are not Word page numbers.
...
Preserve the taxonomy of backtest statistics as separate report categories.

## Cautions to cross-check

Do not collapse performance, runs, shortfall, efficiency, classification and attribution into one score.
