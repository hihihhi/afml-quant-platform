...
**Task:** `S-14.5.2`. **Status:** draft; independent review pending.

**Source:** [OPS/c14.xhtml](../../../01-source/private/epub/OPS/c14.xhtml#c14_5_2); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 288 to 307 (end exclusive); printed markers 201–201. These are not Word page numbers.
...
Reproduce drawdown and time-under-water calculations.

## Cautions to cross-check

Distinguish currency versus percentage drawdowns and peak-to-recovery versus peak-to-trough intervals.
...
- [SNIP-c14-004 — Snippet 14.4 Deriving the sequence of DD and TuW](../snippets/SNIP-c14-004.md)
