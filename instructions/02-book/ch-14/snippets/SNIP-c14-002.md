...
**Task:** `SNIP-c14-002`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 55 to 56 (end exclusive); printed markers 197–197. These are not Word page numbers.
...
Original asset: [OPS/images/s14-02.jpg](../../../01-source/private/epub/OPS/images/s14-02.jpg).
