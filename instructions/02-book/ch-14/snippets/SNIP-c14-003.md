...
**Task:** `SNIP-c14-003`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 283 to 284 (end exclusive); printed markers 200–200. These are not Word page numbers.
...
Original asset: [OPS/images/s14-03.jpg](../../../01-source/private/epub/OPS/images/s14-03.jpg).
