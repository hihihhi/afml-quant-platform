...
**Task:** `SNIP-c14-004`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 302 to 303 (end exclusive); printed markers 201–201. These are not Word page numbers.
...
Original asset: [OPS/images/s14-04.jpg](../../../01-source/private/epub/OPS/images/s14-04.jpg).
