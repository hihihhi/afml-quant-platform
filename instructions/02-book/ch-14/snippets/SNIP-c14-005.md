...
**Task:** `SNIP-c14-005`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 467 to 468 (end exclusive); printed markers 204–204. These are not Word page numbers.
