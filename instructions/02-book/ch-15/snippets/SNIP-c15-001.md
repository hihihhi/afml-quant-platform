...
**Task:** `SNIP-c15-001`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 99 to 100 (end exclusive); printed markers 212–212. These are not Word page numbers.
...
Original asset: [OPS/images/s15-01.jpg](../../../01-source/private/epub/OPS/images/s15-01.jpg).
