...
**Task:** `SNIP-c15-002`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 232 to 233 (end exclusive); printed markers 214–214. These are not Word page numbers.
...
Original asset: [OPS/images/s15-02.jpg](../../../01-source/private/epub/OPS/images/s15-02.jpg).
