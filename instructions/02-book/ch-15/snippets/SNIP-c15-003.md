...
**Task:** `SNIP-c15-003`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 284 to 285 (end exclusive); printed markers 214–214. These are not Word page numbers.
...
Original asset: [OPS/images/s15-03.jpg](../../../01-source/private/epub/OPS/images/s15-03.jpg).
