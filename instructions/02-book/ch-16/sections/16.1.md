...
**Task:** `S-16.1`. **Status:** draft; independent review pending.

**Source:** [OPS/c16.xhtml](../../../01-source/private/epub/OPS/c16.xhtml#c16_1); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 10 to 16 (end exclusive); printed markers 221–221. These are not Word page numbers.
...
State HRP's proposed response to instability, concentration and out-of-sample behavior of quadratic allocations.

## Cautions to cross-check

The source's reported comparisons are not universal guarantees of HRP dominance.
