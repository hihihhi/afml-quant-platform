...
**Task:** `S-16.A.3`. **Status:** draft; independent review pending.

**Source:** [OPS/c16.xhtml](../../../01-source/private/epub/OPS/c16.xhtml#c16_12); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 782 to 800 (end exclusive); printed markers 240–240. These are not Word page numbers.
...
Reproduce the appendix's complete numerical-example code.

## Cautions to cross-check

Keep the source code artifact unchanged and place runnable compatibility edits in a separate reference implementation.
...
- [SNIP-c16-004 — Snippet 16.4 Full implementation of the HRP algorithm](../snippets/SNIP-c16-004.md)
