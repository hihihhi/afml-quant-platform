...
**Task:** `S-16.A.4`. **Status:** draft; independent review pending.

**Source:** [OPS/c16.xhtml](../../../01-source/private/epub/OPS/c16.xhtml#c16_13); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 800 to 812 (end exclusive); printed markers 240–240. These are not Word page numbers.
...
Reproduce the appendix's Monte Carlo experiment code and outputs.

## Cautions to cross-check

Track random generation, sample windows, allocations and aggregation separately for each method.
...
- [SNIP-c16-005 — Snippet 16.5 Monte Carlo experiment on HRP out-of-sample performance](../snippets/SNIP-c16-005.md)
