...
**Task:** `SNIP-c16-001`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 261 to 262 (end exclusive); printed markers 228–228. These are not Word page numbers.
...
Original asset: [OPS/images/s16-01.jpg](../../../01-source/private/epub/OPS/images/s16-01.jpg).
