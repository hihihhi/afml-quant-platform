...
**Task:** `SNIP-c16-002`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 319 to 320 (end exclusive); printed markers 229–229. These are not Word page numbers.
...
Original asset: [OPS/images/s16-02.jpg](../../../01-source/private/epub/OPS/images/s16-02.jpg).
