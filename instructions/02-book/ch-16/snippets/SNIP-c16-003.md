...
**Task:** `SNIP-c16-003`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 434 to 435 (end exclusive); printed markers 230–230. These are not Word page numbers.
...
Original asset: [OPS/images/s16-03.jpg](../../../01-source/private/epub/OPS/images/s16-03.jpg).
