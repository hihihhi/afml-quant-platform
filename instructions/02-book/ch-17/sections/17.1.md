...
**Task:** `S-17.1`. **Status:** draft; independent review pending.

**Source:** [OPS/c17.xhtml](../../../01-source/private/epub/OPS/c17.xhtml#c17_1); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 10 to 14 (end exclusive); printed markers 249–249. These are not Word page numbers.
...
Define structural-break features and the motivation for measuring changing regimes.

## Cautions to cross-check

An ex-post break statistic is not automatically available to a strategy at the apparent break date.
