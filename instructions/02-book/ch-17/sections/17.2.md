...
**Task:** `S-17.2`. **Status:** draft; independent review pending.

**Source:** [OPS/c17.xhtml](../../../01-source/private/epub/OPS/c17.xhtml#c17_2); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 14 to 29 (end exclusive); printed markers 249–250. These are not Word page numbers.
...
Preserve the source's taxonomy of structural-break tests.

## Cautions to cross-check

Different tests target different alternatives and should not share an unlabeled common score.
