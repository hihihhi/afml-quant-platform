...
**Task:** `S-17.4`. **Status:** draft; independent review pending.

**Source:** [OPS/c17.xhtml](../../../01-source/private/epub/OPS/c17.xhtml#c17_4); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 159 to 163 (end exclusive); printed markers 251–251. These are not Word page numbers.
...
Specify tests aimed at explosive behavior and their alternatives.

## Cautions to cross-check

A rejection of one null is not automatically a tradable bubble forecast.
...
- [S-17.4.1 — 17.4.1 Chow-Type Dickey-Fuller Test](17.4.1.md)
- [S-17.4.2 — 17.4.2 Supremum Augmented Dickey-Fuller](17.4.2.md)
- [S-17.4.3 — 17.4.3 Sub- and Super-Martingale Tests](17.4.3.md)
