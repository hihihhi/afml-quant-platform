...
**Task:** `SNIP-c17-001`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 693 to 694 (end exclusive); printed markers 258–258. These are not Word page numbers.
...
Original asset: [OPS/images/s17-01.jpg](../../../01-source/private/epub/OPS/images/s17-01.jpg).
