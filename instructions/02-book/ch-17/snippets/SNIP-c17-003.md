...
**Task:** `SNIP-c17-003`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 706 to 707 (end exclusive); printed markers 258–258. These are not Word page numbers.
...
Original asset: [OPS/images/s17-03.jpg](../../../01-source/private/epub/OPS/images/s17-03.jpg).
