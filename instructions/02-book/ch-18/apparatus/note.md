...
**Task:** `CH-18-note`. **Status:** draft; independent review pending.

**Source:** [OPS/c18.xhtml](../../../01-source/private/epub/OPS/c18.xhtml#notesSet); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 849 to 855 (end exclusive); printed markers 279–279. These are not Word page numbers.
...
Review the note and preserve its anchor and parent reference.

## Cautions to cross-check

Do not drop notes as unimportant formatting during extraction or implementation.
