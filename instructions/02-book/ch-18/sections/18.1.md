...
**Task:** `S-18.1`. **Status:** draft; independent review pending.

**Source:** [OPS/c18.xhtml](../../../01-source/private/epub/OPS/c18.xhtml#c18_1); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 10 to 14 (end exclusive); printed markers 263–263. These are not Word page numbers.
...
Define entropy-based features and the information quantity being estimated.

## Cautions to cross-check

Entropy depends on representation and encoding; it is not a scale-free label for market unpredictability.
