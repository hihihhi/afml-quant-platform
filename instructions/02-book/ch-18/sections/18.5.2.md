...
**Task:** `S-18.5.2`. **Status:** draft; independent review pending.

**Source:** [OPS/c18.xhtml](../../../01-source/private/epub/OPS/c18.xhtml#c18_5_2); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 285 to 293 (end exclusive); printed markers 270–270. These are not Word page numbers.
...
Reproduce quantile encoding and its alphabet construction.

## Cautions to cross-check

Quantile boundaries are fitted quantities; full-sample fitting can leak future distribution information.
