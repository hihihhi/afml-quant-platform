...
**Task:** `S-18.5.3`. **Status:** draft; independent review pending.

**Source:** [OPS/c18.xhtml](../../../01-source/private/epub/OPS/c18.xhtml#c18_5_3); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 293 to 314 (end exclusive); printed markers 270–271. These are not Word page numbers.
...
Reproduce sigma-based encoding and the scale used to form bins.

## Cautions to cross-check

Scale estimation, tails and out-of-range values require reproducible conventions.
...
- [IMG-c18-00309 — IMG-c18-00309 — c18_ILM0019.gif](../equations/IMG-c18-00309.md)
