...
**Task:** `S-18.8.1`. **Status:** draft; independent review pending.

**Source:** [OPS/c18.xhtml](../../../01-source/private/epub/OPS/c18.xhtml#c18_8_1); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 477 to 481 (end exclusive); printed markers 275–275. These are not Word page numbers.
...
Record the market-efficiency interpretation of information and entropy.

## Cautions to cross-check

Encoding and finite-sample effects can change measured entropy without establishing economic inefficiency.
