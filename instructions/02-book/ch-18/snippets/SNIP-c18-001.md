...
**Task:** `SNIP-c18-001`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 125 to 126 (end exclusive); printed markers 265–265. These are not Word page numbers.
...
Original asset: [OPS/images/s18-01.jpg](../../../01-source/private/epub/OPS/images/s18-01.jpg).
