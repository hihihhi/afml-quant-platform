...
**Task:** `SNIP-c18-002`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 134 to 135 (end exclusive); printed markers 266–266. These are not Word page numbers.
...
Original asset: [OPS/images/s18-02.jpg](../../../01-source/private/epub/OPS/images/s18-02.jpg).
