...
**Task:** `SNIP-c18-003`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 163 to 164 (end exclusive); printed markers 266–266. These are not Word page numbers.
...
Original asset: [OPS/images/s18-03.jpg](../../../01-source/private/epub/OPS/images/s18-03.jpg).
