...
**Task:** `SNIP-c18-004`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 253 to 254 (end exclusive); printed markers 268–268. These are not Word page numbers.
...
Original asset: [OPS/images/s18-04.jpg](../../../01-source/private/epub/OPS/images/s18-04.jpg).
