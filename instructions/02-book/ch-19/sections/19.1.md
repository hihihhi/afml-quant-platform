...
**Task:** `S-19.1`. **Status:** draft; independent review pending.

**Source:** [OPS/c19.xhtml](../../../01-source/private/epub/OPS/c19.xhtml#c19_1); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 10 to 14 (end exclusive); printed markers 281–281. These are not Word page numbers.
...
Define microstructural features as information extracted from trading mechanisms and order flow.

## Cautions to cross-check

An event's market context matters; coarsened bars may not contain the required evidence.
