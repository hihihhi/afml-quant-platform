...
**Task:** `S-19.2`. **Status:** draft; independent review pending.

**Source:** [OPS/c19.xhtml](../../../01-source/private/epub/OPS/c19.xhtml#c19_2); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 14 to 21 (end exclusive); printed markers 281–282. These are not Word page numbers.
...
Preserve the three-generation literature framing and references.

## Cautions to cross-check

Historical models and literature claims should not be silently presented as current exchange specifications.
