...
**Task:** `S-19.6.1`. **Status:** draft; independent review pending.

**Source:** [OPS/c19.xhtml](../../../01-source/private/epub/OPS/c19.xhtml#c19_6_1); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 521 to 526 (end exclusive); printed markers 293–293. These are not Word page numbers.
...
Record distributional features of order sizes while preserving the source heading's spelling.

## Cautions to cross-check

The uploaded heading says “Distibution”; record the typographic correction separately as ERR-0002.
