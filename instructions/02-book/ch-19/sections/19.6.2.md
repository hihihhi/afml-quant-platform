...
**Task:** `S-19.6.2`. **Status:** draft; independent review pending.

**Source:** [OPS/c19.xhtml](../../../01-source/private/epub/OPS/c19.xhtml#c19_6_2); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 526 to 542 (end exclusive); printed markers 293–294. These are not Word page numbers.
...
Specify cancellation, limit-order and market-order activity features.

## Cautions to cross-check

A cancellation/replacement and a cancellation without replacement carry different information.
