...
**Task:** `S-19.6.4`. **Status:** draft; independent review pending.

**Source:** [OPS/c19.xhtml](../../../01-source/private/epub/OPS/c19.xhtml#Page_295); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 547 to 556 (end exclusive); printed markers 295–295. These are not Word page numbers.
...
Catalogue options-market feature proposals and their required option/underlying observations.

## Cautions to cross-check

Strike, maturity, contract multipliers and data availability cannot be discarded in a cross-market adapter.
