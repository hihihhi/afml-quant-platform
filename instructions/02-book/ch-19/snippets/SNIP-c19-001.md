...
**Task:** `SNIP-c19-001`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 200 to 201 (end exclusive); printed markers 285–285. These are not Word page numbers.
...
Original asset: [OPS/images/s19-01.jpg](../../../01-source/private/epub/OPS/images/s19-01.jpg).
