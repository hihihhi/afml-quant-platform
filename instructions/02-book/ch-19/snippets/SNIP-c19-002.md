...
**Task:** `SNIP-c19-002`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 205 to 206 (end exclusive); printed markers 285–285. These are not Word page numbers.
...
Original asset: [OPS/images/s19-02.jpg](../../../01-source/private/epub/OPS/images/s19-02.jpg).
