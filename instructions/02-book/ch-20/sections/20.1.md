...
**Task:** `S-20.1`. **Status:** draft; independent review pending.

**Source:** [OPS/c20.xhtml](../../../01-source/private/epub/OPS/c20.xhtml#c20_1); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 10 to 15 (end exclusive); printed markers 303–303. These are not Word page numbers.
...
Define the computational objective while retaining the mathematical task being accelerated.

## Cautions to cross-check

Parallelism must not be accepted on speed claims without correctness and workload evidence.
