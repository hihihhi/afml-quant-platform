...
**Task:** `S-20.4.1`. **Status:** draft; independent review pending.

**Source:** [OPS/c20.xhtml](../../../01-source/private/epub/OPS/c20.xhtml#c20_4_1); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 54 to 75 (end exclusive); printed markers 305–307. These are not Word page numbers.
...
Reproduce the linear-partition calculation and boundary rounding.

## Cautions to cross-check

Test empty/small workloads and exact coverage with no skipped or repeated atoms.
...
- [SNIP-c20-005 — SNIPPET 20.5 The linParts FUNCTION](../snippets/SNIP-c20-005.md)
