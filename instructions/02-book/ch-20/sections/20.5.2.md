...
**Task:** `S-20.5.2`. **Status:** draft; independent review pending.

**Source:** [OPS/c20.xhtml](../../../01-source/private/epub/OPS/c20.xhtml#c20_5_2); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 258 to 276 (end exclusive); printed markers 310–312. These are not Word page numbers.
...
Reproduce asynchronous dispatch and completion handling.

## Cautions to cross-check

Completion order differs from input order and worker exceptions must not disappear.
...
- [SNIP-c20-009 — Snippet 20.9 Example of asynchronous call to python’s multiprocessing library](../snippets/SNIP-c20-009.md)
