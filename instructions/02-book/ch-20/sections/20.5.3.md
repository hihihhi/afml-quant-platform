...
**Task:** `S-20.5.3`. **Status:** draft; independent review pending.

**Source:** [OPS/c20.xhtml](../../../01-source/private/epub/OPS/c20.xhtml#c20_5_3); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 276 to 288 (end exclusive); printed markers 312–312. These are not Word page numbers.
...
Reproduce callback unwrapping and invocation of the intended function.

## Cautions to cross-check

Serialization-friendly wrappers must not alter the callable's arguments or result semantics.
...
- [SNIP-c20-010 — Snippet 20.10 Passing the job (molecule) to the callback function](../snippets/SNIP-c20-010.md)
