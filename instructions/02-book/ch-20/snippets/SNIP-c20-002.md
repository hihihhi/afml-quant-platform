...
**Task:** `SNIP-c20-002`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 29 to 30 (end exclusive); printed markers 304–304. These are not Word page numbers.
...
Original asset: [OPS/images/s20-02.jpg](../../../01-source/private/epub/OPS/images/s20-02.jpg).
