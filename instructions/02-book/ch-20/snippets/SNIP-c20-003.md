...
**Task:** `SNIP-c20-003`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 39 to 40 (end exclusive); printed markers 305–305. These are not Word page numbers.
...
Original asset: [OPS/images/s20-03.jpg](../../../01-source/private/epub/OPS/images/s20-03.jpg).
