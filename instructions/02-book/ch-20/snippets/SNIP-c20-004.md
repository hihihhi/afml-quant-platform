...
**Task:** `SNIP-c20-004`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 44 to 45 (end exclusive); printed markers 305–305. These are not Word page numbers.
...
Original asset: [OPS/images/s20-04.jpg](../../../01-source/private/epub/OPS/images/s20-04.jpg).
