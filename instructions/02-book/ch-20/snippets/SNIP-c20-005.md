...
**Task:** `SNIP-c20-005`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 60 to 61 (end exclusive); printed markers 305–305. These are not Word page numbers.
...
Original asset: [OPS/images/s20-05.jpg](../../../01-source/private/epub/OPS/images/s20-05.jpg).
