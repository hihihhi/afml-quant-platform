...
**Task:** `SNIP-c20-006`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 177 to 178 (end exclusive); printed markers 308–308. These are not Word page numbers.
...
Original asset: [OPS/images/s20-06.jpg](../../../01-source/private/epub/OPS/images/s20-06.jpg).
