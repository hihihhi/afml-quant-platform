...
**Task:** `SNIP-c20-009`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 271 to 272 (end exclusive); printed markers 310–310. These are not Word page numbers.
...
Original asset: [OPS/images/s20-09.jpg](../../../01-source/private/epub/OPS/images/s20-09.jpg).
