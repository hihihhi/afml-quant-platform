...
**Task:** `SNIP-c20-010`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 284 to 285 (end exclusive); printed markers 312–312. These are not Word page numbers.
...
Original asset: [OPS/images/s20-10.jpg](../../../01-source/private/epub/OPS/images/s20-10.jpg).
