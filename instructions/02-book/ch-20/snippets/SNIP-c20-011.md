...
**Task:** `SNIP-c20-011`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 295 to 296 (end exclusive); printed markers 313–313. These are not Word page numbers.
...
Original asset: [OPS/images/s20-11.jpg](../../../01-source/private/epub/OPS/images/s20-11.jpg).
