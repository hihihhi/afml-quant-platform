...
**Task:** `SNIP-c20-014`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 403 to 404 (end exclusive); printed markers 316–316. These are not Word page numbers.
...
Original asset: [OPS/images/s20-14.jpg](../../../01-source/private/epub/OPS/images/s20-14.jpg).
