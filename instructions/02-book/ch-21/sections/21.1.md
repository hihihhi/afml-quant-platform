...
**Task:** `S-21.1`. **Status:** draft; independent review pending.

**Source:** [OPS/c21.xhtml](../../../01-source/private/epub/OPS/c21.xhtml#c21_1); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 10 to 14 (end exclusive); printed markers 319–319. These are not Word page numbers.
...
Define the discrete-optimization problem and the chapter's motivation for brute force and quantum approaches.

## Cautions to cross-check

The discussion does not establish an available quantum advantage for this platform.
