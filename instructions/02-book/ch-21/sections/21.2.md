...
**Task:** `S-21.2`. **Status:** draft; independent review pending.

**Source:** [OPS/c21.xhtml](../../../01-source/private/epub/OPS/c21.xhtml#c21_2); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 14 to 22 (end exclusive); printed markers 319–320. These are not Word page numbers.
...
Reproduce the combinatorial optimization framing.

## Cautions to cross-check

The feasible set and objective must be stated before selecting a solver.
