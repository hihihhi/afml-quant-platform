...
**Task:** `S-21.4`. **Status:** draft; independent review pending.

**Source:** [OPS/c21.xhtml](../../../01-source/private/epub/OPS/c21.xhtml#c21_4); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 98 to 121 (end exclusive); printed markers 321–321. These are not Word page numbers.
...
Specify the dynamic allocation problem and its constraints.

## Cautions to cross-check

A solution to a static allocation problem is not automatically optimal over a trajectory.
...
- [IMG-c21-00103 — IMG-c21-00103 — c21_M0003.gif](../equations/IMG-c21-00103.md)
