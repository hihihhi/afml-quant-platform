...
**Task:** `S-21.6.3`. **Status:** draft; independent review pending.

**Source:** [OPS/c21.xhtml](../../../01-source/private/epub/OPS/c21.xhtml#Page_327); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 260 to 269 (end exclusive); printed markers 327–327. These are not Word page numbers.
...
Reproduce the dynamic solution and compare the whole trajectory with the static baseline.

## Cautions to cross-check

A higher computed objective may depend on discretization and assumed transaction costs, not only solver quality.
...
- [SNIP-c21-007 — Snippet 21.7 Compute and evaluate the dynamic solution](../snippets/SNIP-c21-007.md)
