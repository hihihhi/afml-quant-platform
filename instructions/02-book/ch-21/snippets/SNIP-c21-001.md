...
**Task:** `SNIP-c21-001`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 158 to 159 (end exclusive); printed markers 322–322. These are not Word page numbers.
...
Original asset: [OPS/images/s21-01.jpg](../../../01-source/private/epub/OPS/images/s21-01.jpg).
