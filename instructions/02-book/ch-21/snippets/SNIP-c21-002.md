...
**Task:** `SNIP-c21-002`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 207 to 208 (end exclusive); printed markers 323–323. These are not Word page numbers.
...
Original asset: [OPS/images/s21-02.jpg](../../../01-source/private/epub/OPS/images/s21-02.jpg).
