...
**Task:** `SNIP-c21-003`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 221 to 222 (end exclusive); printed markers 323–323. These are not Word page numbers.
...
Original asset: [OPS/images/s21-03.jpg](../../../01-source/private/epub/OPS/images/s21-03.jpg).
