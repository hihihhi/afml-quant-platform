...
**Task:** `SNIP-c21-004`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 237 to 238 (end exclusive); printed markers 325–325. These are not Word page numbers.
...
Original asset: [OPS/images/s21-04.jpg](../../../01-source/private/epub/OPS/images/s21-04.jpg).
