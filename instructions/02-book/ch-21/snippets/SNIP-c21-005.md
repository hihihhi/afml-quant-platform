...
**Task:** `SNIP-c21-005`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 247 to 248 (end exclusive); printed markers 325–325. These are not Word page numbers.
...
Original asset: [OPS/images/s21-05.jpg](../../../01-source/private/epub/OPS/images/s21-05.jpg).
