...
**Task:** `SNIP-c21-006`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 256 to 257 (end exclusive); printed markers 326–326. These are not Word page numbers.
...
Original asset: [OPS/images/s21-06.jpg](../../../01-source/private/epub/OPS/images/s21-06.jpg).
