...
**Task:** `SNIP-c21-007`. **Status:** draft; independent review pending.
...
**Direct source locator:** body-iterator positions 265 to 266 (end exclusive); printed markers 327–327. These are not Word page numbers.
...
Original asset: [OPS/images/s21-07.jpg](../../../01-source/private/epub/OPS/images/s21-07.jpg).
