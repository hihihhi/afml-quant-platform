...
**Task:** `CH-22-references`. **Status:** draft; independent review pending.

**Source:** [OPS/c22.xhtml](../../../01-source/private/epub/OPS/c22.xhtml#c22-bibl-0001); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 269 to 343 (end exclusive); printed markers 350–352. These are not Word page numbers.
...
Preserve each cited reference and connect it to the claims or methods that depend on it.

## Cautions to cross-check

A reference entry is not evidence that the cited work has been retrieved or verified. External review needs its own record.
...
- [IMG-c22-00275 — IMG-c22-00275 — c22_ILM0001.gif](../equations/IMG-c22-00275.md)
