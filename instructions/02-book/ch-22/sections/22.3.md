...
**Task:** `S-22.3`. **Status:** draft; independent review pending.

**Source:** [OPS/c22.xhtml](../../../01-source/private/epub/OPS/c22.xhtml#c22_3); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 23 to 37 (end exclusive); printed markers 330–331. These are not Word page numbers.
...
Record the scientific-computing background motivating the chapter's approach.

## Cautions to cross-check

Cross-domain examples are methodological context, not direct evidence of profitable trading.
