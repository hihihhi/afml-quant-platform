...
**Task:** `S-22.5.1`. **Status:** draft; independent review pending.

**Source:** [OPS/c22.xhtml](../../../01-source/private/epub/OPS/c22.xhtml#c22_5_1); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 84 to 90 (end exclusive); printed markers 335–335. These are not Word page numbers.
...
Record MPI's role in distributed computations and inter-process communication.

## Cautions to cross-check

A proposed C++ implementation must separately define collective ordering, error handling and determinism.
