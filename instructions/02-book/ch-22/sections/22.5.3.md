...
**Task:** `S-22.5.3`. **Status:** draft; independent review pending.

**Source:** [OPS/c22.xhtml](../../../01-source/private/epub/OPS/c22.xhtml#c22_5_3); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 100 to 112 (end exclusive); printed markers 336–337. These are not Word page numbers.
...
Record in-situ processing and its relationship to data movement and storage.

## Cautions to cross-check

Avoid assuming that eliminating an intermediate transfer eliminates the need for recoverable source data.
