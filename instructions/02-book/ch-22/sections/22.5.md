...
**Task:** `S-22.5`. **Status:** draft; independent review pending.

**Source:** [OPS/c22.xhtml](../../../01-source/private/epub/OPS/c22.xhtml#c22_5); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 79 to 84 (end exclusive); printed markers 335–335. These are not Word page numbers.
...
Catalogue the software stack and the distinct roles of communication, data format and in-situ processing.

## Cautions to cross-check

The book's software discussion is not a fully specified database or production-service architecture.
...
- [S-22.5.1 — 22.5.1 Message Passing Interface](22.5.1.md)
- [S-22.5.2 — 22.5.2 Hierarchical Data Format 5](22.5.2.md)
- [S-22.5.3 — 22.5.3 In Situ Processing](22.5.3.md)
- [S-22.5.4 — 22.5.4 Convergence](22.5.4.md)
