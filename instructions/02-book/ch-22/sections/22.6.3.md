...
**Task:** `S-22.6.3`. **Status:** draft; independent review pending.

**Source:** [OPS/c22.xhtml](../../../01-source/private/epub/OPS/c22.xhtml#c22_6_3); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 154 to 177 (end exclusive); printed markers 340–341. These are not Word page numbers.
...
Preserve the intraday peak-electricity-usage forecasting example.

## Cautions to cross-check

The target, sampling and availability assumptions differ from securities-return prediction.
