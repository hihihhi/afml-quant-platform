...
**Task:** `S-22.6.6`. **Status:** draft; independent review pending.

**Source:** [OPS/c22.xhtml](../../../01-source/private/epub/OPS/c22.xhtml#c22_6_6); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 229 to 249 (end exclusive); printed markers 347–349. These are not Word page numbers.
...
Record the use of the non-uniform fast Fourier transform for high-frequency events.

## Cautions to cross-check

Irregular-time sampling, transform normalization and event interpretation require explicit definitions.
