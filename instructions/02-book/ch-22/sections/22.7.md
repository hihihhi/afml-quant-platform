...
**Task:** `S-22.7`. **Status:** draft; independent review pending.

**Source:** [OPS/c22.xhtml](../../../01-source/private/epub/OPS/c22.xhtml#c22_7); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 249 to 264 (end exclusive); printed markers 349–350. These are not Word page numbers.
...
Preserve the summary and call for participation as the book's concluding framing.

## Cautions to cross-check

A call for participation does not authorize external outreach, data sharing or deployment.
