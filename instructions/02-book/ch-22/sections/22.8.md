...
**Task:** `S-22.8`. **Status:** draft; independent review pending.

**Source:** [OPS/c22.xhtml](../../../01-source/private/epub/OPS/c22.xhtml#c22_8); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 264 to 269 (end exclusive); printed markers 350–350. These are not Word page numbers.
...
Preserve acknowledgments and attribution.

## Cautions to cross-check

Do not infer software requirements or contact permissions from this apparatus.
