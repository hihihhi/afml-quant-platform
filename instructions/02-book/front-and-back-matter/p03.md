# Source apparatus: OPS/p03.xhtml

**Task:** `p03`. **Status:** draft; independent review pending.

**Source:** [OPS/p03.xhtml](../../01-source/private/epub/OPS/p03.xhtml); source EPUB SHA-256 `48295c01e8fef21098a10c3fa7b17eafe7830854614c5d882c978cfbceda6c7a`.

**Direct source locator:** body-iterator positions 0 to 25 (end exclusive); printed markers –. These are not Word page numbers.
